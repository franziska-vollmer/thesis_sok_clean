...
for run in range(n_runs):
    ...
    print(f"Run {run+1}: Acc {test_accuracy:.4f}, Precision {precision:.4f}, Recall {recall:.4f}, F1 {f1:.4f}, AUC {auc:.4f}")
...
plt.title("Cross-Validation Performance über verschiedene Test-CVE-Splits (inkl. AUC)")
plt.grid(True)
plt.show()
