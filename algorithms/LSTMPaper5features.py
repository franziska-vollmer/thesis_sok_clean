...
# Nur bestimmte Features extrahieren
selected_features = [491, 105, 344, 479, 552, 47, 62, 232, 291, 60,
                     352, 255, 319, 553, 145, 234, 396, 95, 83, 518]

X = combined_data.iloc[:, selected_features].values  # Merkmale reduziert
